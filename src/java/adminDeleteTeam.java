 ...
 * @author kunal
 */
public class adminDeleteTeam extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                PreparedStatement preparedStatement = new db.Connect_db().getConnection().prepareStatement("DELETE FROM team WHERE id=?;");
