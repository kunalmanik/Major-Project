...
public class adminEditTeamImage extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           //frmOpt.setAlwaysOnTop(true);
            ...
            try{
                ...
                PreparedStatement preparedStatement = con.prepareStatement("UPDATE team SET image=? WHERE id=? ;");
                preparedStatement.setString(1, fileName);
                preparedStatement.setString(2, id);
                preparedStatement.executeUpdate();
                    out.println("<script type=\"text/javascript\">");  
                   out.println("alert('Image Uploaded Successfully');");
                   out.println("window.location.href = 'admin/viewTeam.jsp?msg=success'");
                   out.println("</script>");
               // JOptionPane.showMessageDialog(frmOpt, "Image Uploaded Successfully");
               // frmOpt.dispose();
               // response.sendRedirect("admin/viewTeam.jsp?msg=success");
            }
            catch(Exception e){
