...
<!--Spinner-->
	...
	<!-- //header -->
        ...
        <div class="container"> 
	        ...
	        <h3 class="agileits-title w3title1">Rules & Regulations</h3>
	    </div>
            <h5 style="color:teal;"><strong>PLEASE READ THESE RULES & REGULATIONS CAREFULLY .</strong></h5>
            <div style="margin-top:30px; margin-bottom:30px;">
				
                <a data-toggle="collapse"  data-target="#demo"><strong>Bunking Class</strong></a>
                                <br>
