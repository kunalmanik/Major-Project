...
<html lang="en">
<head>
<title>E.M.S. School | Codes </title> 
...
<body>
		...
		<nav class="navbar navbar-default">
			<div class="container">
				<div class="navbar-header navbar-left wthree">
					<h1><a href="index.jsp">Edify<span>College Education</span></a></h1>
				</div>
				<!-- navigation -->
	...
	<div class="typo">
		<div class="container">
			...
			<div class="grid_3 grid_4 dictiontechnology">
			...
			<div class="grid_3 grid_5 wthree">
				<h3>Badges</h3>
				<div class="col-md-6 agileits-dictiontechnology">
			...
			<div class="input-group w3_dictiontechnology">
			...
			<div class="input-group input-group-lg w3_dictiontechnology">
			...
			<div class="input-group input-group-sm w3_dictiontechnology">
...
<!-- //typography -->
	...
	<div class="footer">
		<div class="container">
			<div class="col-md-4 dictiontechnology_footer_grid"> 
				<div class="title">
					<h2>Follow Us</h2> 
				</div>
			...
			<div class="col-md-8 dictiontechnology_footer_grid">
				<form action="#" method="post">
	...
	<div class="footer-w3copy w3-agileits">
		<p>© 2017 Edify. All Rights Reserved | Design by <a href="https://dictiontechnology.com/" target="_blank">dictiontechnology</a></p>
	</div>
	<!-- //footer -->    
