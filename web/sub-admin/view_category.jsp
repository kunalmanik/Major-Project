<%-- 
    ...
    Created on : 20 Feb, 2018, 1:39:05 AM
    Author     : kunal
--%>
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                <% while (rs.next()) { %>
                    <tr>
                       ...
                       <td>           <td>
                      <a href="subadminEditCat.jsp?cat_id=<%=rs.getString("cat_id")%>&cat_name=<%=rs.getString("cat_name")%>"> EDIT </a> </td>
                      <td> <a href="subadminDeleteCat.jsp?id=<%=rs.getString("cat_id")%>" > DELETE</a>
