<%-- 
    Document   : error404
    Created on : 20 Feb, 2018, 1:23:12 AM
    Author     : kunal
--%>
    ...
    <body>
        <div class="container_16">
            <div class="grid_14 push_1" id="whiteBox" style="padding: 10px;">
                <br/><h1 style="padding: 10px;"><span>Error Status 404</span>
                </h1><hr/><br/>
                <p  class="grid_4" style="text-align: center; font-size: 52px;">404 Page Not found!!</p>
                <p class="grid_7">
                ...
                <form action="subadmin_login.jsp">
