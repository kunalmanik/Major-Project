<%-- 
    Document   : editsubsubcatimg
    Created on : 20 Feb, 2018, 3:58:50 AM
    Author     : kunal
--%>
...
<table align="center"  >                        
                        <form  action="../sub_updatesubsubcatimg" method="post" enctype="multipart/form-data">               
...
<tr> <td> <th>Image</th></td>
    <td> <img src="../products/<%=rs.getString("product_image")%>"></td>
</tr>
