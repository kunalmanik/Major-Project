<%-- 
    Document   : editimgsubcat
    Created on : 23 Feb, 2018, 10:45:30 AM
    Author     : kunal
--%>
...
<table align="center"  >                        
                        <form  action="../updatesubcatimg" method="post" enctype="multipart/form-data">               
...
String query = "select * from sub_category where sub_id='"+id1+"'";
...
<tr> <td>  <th>Category</th></td>
    <td><input value="<%=id1%>" type="hidden" name="proid"><label type="text" name="sub_id" style="margin: 10px" readonly><%=rs.getString("cat_name")%></label></td>
</tr>
<tr> <td> <th>Sub Category</th></td>
    <td><label type="text" name="productName" style="margin: 10px"><%=rs.getString("subcat")%></label></td>
</tr>
<tr> <td> <th>Image</th></td>
    <td> <img src="../gallery/subcat_images/<%=rs.getString("sub_image")%>" style="height: 200px;  width: 200px"></td>
</tr>
