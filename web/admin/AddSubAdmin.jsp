                  ...
                  <div class="col-md-6 col-md offset-2" >
                    <div class="card">
                      <div class="card-header">
                        <strong>Add</strong> Sub Admin
                      </div>
                      <div>
                          <form action="../adminAddSubAdmin" method="post" class="form-horizontal"  >
                          <div >
                            <div ><label>Name</label></div>
                            <div><input type="text" id="cat_name" name="name" class="form-control" placeholder="Enter the Sub Admin's Name" ><div>
                          </div>
                           <div >
                            <div ><label  >Username</label></div>
                            <div><input type="text" id="cat_name" name="username" class="form-control" placeholder="Enter the Username" ><div>
                          </div>
                                <div >
                            <div ><label  >Email</label></div>
                            <div><input type="email" id="cat_name" name="email" class="form-control" placeholder="Enter the Email" ><div>
                          </div>
                                <div >
                            <div ><label  >Password</label></div>
                            <div><input type="text" id="cat_name" name="password" class="form-control" placeholder="Enter the Password" ><div>
                          </div>
