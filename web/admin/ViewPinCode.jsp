<%-- 
    Document   : ViewPinCode
    Created on : 20 Feb, 2018, 1:01:28 PM
    Author     : kunal
--%>
                    ...
                    <div class="card">
                      ...
                      <div>
                          ...
                          <div >
                            ...
                            <table>
                                <th><label style="margin: 10px">Pin Code</label></th>
                                <th><label style="margin: 10px">Actions</label></th>
                            <%
                                PreparedStatement ps = new db.Connect_db().getConnection().prepareStatement("SELECT * FROM pincode;");
                                ResultSet rs = ps.executeQuery();
                                while(rs.next())
                                {
                            %>
                                <tr><td><label style="margin: 10px"><%=rs.getString("pincode")%></label></td>
                                    <td><a href="../DeletePinCode?id=<%=rs.getString("id")%>"><label style="margin: 10px">DELETE</label></a></td></tr>
                            <%
                                }
                            %>
                            </table>
