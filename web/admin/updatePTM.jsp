<%-- 
    Document   : updatePTM
    Created on : 17 May, 2018, 7:31:16 PM
    Author     : kunal
--%>
...
<html>
    ...
    <title>About Us - Blossom Flower Gallery</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <center>
                            <%
                                String desc = null;
                                PreparedStatement ps = new db.Connect_db().getConnection().prepareStatement("SELECT * FROM ptm");
                            ...
                            %>
                            <form action="updatePTM_up.jsp" method="post"> 
                            
                            <table class="" style="margin: 50px">
                                ...
                                <tr> <td> </td> <td> </td></tr>
                                 <tr>
                                    <td> Description </td>
                                    <td> <textarea required="" name="des" rows="10" cols="78" style="margin: 20px"><%=desc%></textarea></td>
                                </tr>
                                 <tr>
