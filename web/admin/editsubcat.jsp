...
<input type="text" name="id" value="<%=rs.getString("sub_id")%>" readonly  hidden="">
<tr>
<td><label>Category Name:</label><input type="text" name="category" value="<%=rs.getString("cat_name")%>" readonly>
<select name="status">
...
<br>
<tr>
    <td><label>Sub Category :&nbsp; &nbsp;</label><input type="text" name="subcat" value="<%=rs.getString("subcat")%>"></td>
    &nbsp;<td><input type="submit" class="btn-success" name="Submit" value="Update" size="25"></td>  
</tr>
<tr>
