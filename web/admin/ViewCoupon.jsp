<%-- 
    Document   : ViewCoupon
    Created on : 19 Feb, 2018, 12:46:20 PM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
   ...
   <%
                ...
                PreparedStatement r=con.prepareStatement("SELECT * FROM coupon;");
    ...
    <tr>
        ...
        <td>  <%= rs.getString("coupon_name")%> </td>        
        <td> <%= rs.getString("coupon_discount")%></td>
        <td>  <%= rs.getString("active")%> </td>         
        <td> <%= rs.getString("uses")%></td>
        
       <td>
           <a href="../AddCoupon?id=<%=rs.getString("id")%>&active=<%=rs.getString("active")%>">Edit Activation</a>
           
       &nbsp;
       <a href="../DeleteCoupon?id=<%=rs.getInt("id")%>">Delete</a>
