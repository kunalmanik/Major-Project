...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                PreparedStatement ps =con.prepareStatement("SELECT * FROM terms");
                ResultSet rs = null;
                rs= ps.executeQuery();%>
                ...
                <tr>  
                    <td><p><strong>Action</strong></p> </td>
                      <td>
                          <a href="adminEditTC.jsp?id=<%=rs.getString("id")%>&des=<%=rs.getString("description")%>"><strong>EDIT</strong> </a>  &nbsp;
                          <a href="adminDeleteTC.jsp?id=<%=rs.getString("id")%>" ><strong> DELETE</strong></a>
