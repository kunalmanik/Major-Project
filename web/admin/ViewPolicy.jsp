<%-- 
    Document   : ViewPolicy
    Created on : 5 Mar, 2018, 3:35:55 PM
    Author     : kunal
--%>
                    ...
                    <div class="card">
                      ...
                      <div>
                          ...
                          <div >
                            ...
                            <table>
                                <th><label style="margin: 10px">Policy</label></th>
                                <th><label style="margin: 10px">Actions</label></th>
                            <%
                                PreparedStatement ps = new db.Connect_db().getConnection().prepareStatement("SELECT * FROM policy;");
                                ResultSet rs = ps.executeQuery();
                                while(rs.next())
                                {
                            %>
                                <tr>
                                    <td><label style="margin: 10px"><%=rs.getString("policy")%></label></td>
                                    <td><a href="../DeletePolicy?id=<%=rs.getString("id")%>"><label style="margin: 10px">DELETE</label></a></td>
                                    <td><a href="adminEditPolicy.jsp?id=<%=rs.getString("id")%>&desc=<%=rs.getString("policy")%>"><label style="margin: 10px">EDIT</label></a></td>
                                </tr>
                            <%
                                }
                            %>
