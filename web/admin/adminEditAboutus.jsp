...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
                ...
                <form action="aboutusAdd.jsp" method="post">
                    
                <table id="bootstrap-data-table" class="table table-striped table-bordered" >
<!--                <tr><td><p style="padding-left: 30px;">ID : </p> </td> <td style="">  </td></tr>
                -->
                <input type="hidden" name="id" value="<%=id%>">
                <tr> <td> <p style="padding-left: 30px;">Header : </p></td> <td> <input type="text" value="<%=head%>"></td>
                <tr> <td> <p style="padding-left: 30px;"> Select Header : </td> <td><select name="head" style=" width: 140px;">
