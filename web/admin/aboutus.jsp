            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <center>
                            <form action="aboutusAdd.jsp"> 
                            
                            <table class="" style="margin: 100px">
                            
                                <tr style="margin: 20px">
                                    <td> Heading</td>
                                    <td>  <select name="head" style="margin-left: 20px; width: 140px;">
                                ...
                                <tr> <td> </td> <td> </td></tr>
                                 <tr>
                                    <td> Description </td>
                                    <td> <textarea required="" name="des" rows="6" cols="48" style="margin: 20px"></textarea></td>
                                </tr>
                                 <tr>
