...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
          ...
          <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                <tr><td><p><strong> Heading</strong></p></td><td> <%=rs.getString("header")%></td></tr>
                <tr><td><p><strong>Description</strong></p> </td><td> <%=rs.getString("description")%></td></tr>
                       
                <tr>  
                    <td><p><strong>Action</strong></p> </td>
                      <td>
                          <a href="adminEditRules.jsp?id=<%=rs.getString("id")%>&heading=<%=rs.getString("header")%>&des=<%=rs.getString("description")%>"><strong>EDIT</strong> </a>  &nbsp;
                          <a href="../DeleteRules?id=<%=rs.getString("id")%>" ><strong> DELETE</strong></a>
