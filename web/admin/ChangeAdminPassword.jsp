            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <center>
                            <div>
                                <table width="auto" height ="40%" class="table" align="center">
                                    
                                    <form method="post" action="../PasswordChangeAd">
    
    <tr>
     <td ><p>Old Password:</p></td>
     <td><input type="password" name="oldPass" id="oldPass" placeholder="Enter your old password" required /></td>
    </tr>
    <tr>
      <td> <p> New Password:</p></td>
      <td><input type="Password" name="pass"  id="newPass" placeholder="Enter your New Password" required></td>
   </tr>
   <tr>
      <td> <p> Re-Enter New Password:</p></td>
      <td><input type="Password" name="Confpass" id="confPass" placeholder="Re-Enter your New Password" required></td>
   </tr>
   <tr>
     <td></td>
     <td> 
         ...
         <input type="submit" class="btn-outline-primary" onclick="return checkPass();" value="Submit"/>
     </td>
  </tr>
