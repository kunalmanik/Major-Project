...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                PreparedStatement ps =con.prepareStatement("SELECT * FROM about_us");
                ResultSet rs = null;
                rs= ps.executeQuery();%>
                ...
                <tr><td><p><strong> Header</strong></p></td><td> <%=rs.getString("header")%></td></tr>
                <tr><td><p><strong>Description</strong></p> </td><td> <%=rs.getString("description")%></td></tr>
                       
                <tr>  
                    <td><p><strong>Action</strong></p> </td>
                      <td>
                          <a href="adminEditAboutus.jsp?id=<%=rs.getString("id")%>&head=<%=rs.getString("header")%>&desc=<%=rs.getString("description")%>"><strong>EDIT</strong> </a>  &nbsp;
                          <a href="adminDeleteAboutUs.jsp?id=<%=rs.getString("id")%>" ><strong> DELETE</strong></a>
