<%-- 
    Document   : ViewSubAdmin
    Created on : 20 Feb, 2018, 12:25:15 PM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                PreparedStatement ps =con.prepareStatement("SELECT * FROM sub_admin");
                ResultSet rs = null;
                rs= ps.executeQuery();%>
                ...
                <% while (rs.next()) { %>
                    <tr>
                       ...
                       <td> <%=rs.getString("sub_admin_name")%></td>
                       <td><%=rs.getString("sub_admin_username")%></td>
                       <td><%=rs.getString("sub_admin_email")%></td>
                       <td><%=rs.getString("sub_admin_password")%></td>
<!--                      <td>
                      <a href="adminEditCat.jsp?cat_id=<%=rs.getString("id")%>"> EDIT </a> </td>-->
                      
                     <td> <a href="../SubAdminDelete?id=<%=rs.getString("id")%>" > DELETE</a>
