...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <table> 
            <tr>
                ...
                <th><label>Boarding-Tution</label></th>
                <th><label>One Time Fee</label></th>
                <th><label>Student Fund</label></th>
                <th><label>Infra structure</label></th>
    ...
    %>
        ...
        <tr>        
            ...
            <td><label> <%=rs.getString("class")%></label></td>
            <td><label>&#8377; <%=rs.getString("board")%></label></td>
            <td><label>&#8377; <%=rs.getString("onetime")%></label></td>
            <td><label>&#8377; <%=rs.getString("student")%></label></td>
            <td><label>&#8377; <%=rs.getString("infra")%></label></td>
            <td><label>&#8377; <%=rs.getString("extra")%></label></td>
            <td><label>&#8377; <%=tot%>/-</label></td>
            <td><input type="hidden" name="class" value="<%=rs.getString("class")%>"></td>
            <td><input type="hidden" name="board" value="<%=rs.getString("board")%>"></td>
            <td><input type="hidden" name="onetime" value="<%=rs.getString("onetime")%>"></td>
            <td><input type="hidden" name="student" value="<%=rs.getString("student")%>"></td>
            <td><input type="hidden" name="infra" value="<%=rs.getString("infra")%>"></td>
            <td><input type="hidden" name="extra" value="<%=rs.getString("extra")%>"></td>
            <td><input type="hidden" name="total" value="<%=tot%>"></td>
                <td>
                    <a href="editFee.jsp?class=<%=rs.getString("class")%>&board=<%=rs.getString("board")%>&onetime=<%=rs.getString("onetime")%>&student=<%=rs.getString("student")%>&infra=<%=rs.getString("infra")%>&extra=<%=rs.getString("extra")%>&id=<%=rs.getString("id")%>">
                    <input type="submit" class="btn btn-info" name="submit" value="Edit" style="margin: 15px;">
                     </a>
                    
                    
                    <a href="DeleteFee.jsp?id=<%=rs.getString("id")%>">
                    <input type="submit" class="btn btn-info" name="submit" value="Delete" style="margin: 15px;">
                     </a>
                    </td>
