...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <tr>
                  <td>Class </td>
                  <td><input type="text" name="class" value="" required="" style="width: 100%"/> </td>
              </tr>
              <tr>
                  <td>Board - Tution </td>
                  <td><input type="number" name="board" value="0" required="" style="width: 100%"/> </td>
              </tr>
              <tr>
                   <td> One Time Fee</td>
                   <td><input type="number" name="onetime" value="0" style="width: 100%" /> </td>
              </tr>
               <tr>
                   <td> Student Fund</td>
                <td> <input type="number" name="student" value="0" style="width: 100%" required=""/></td>
                  
               </tr>
               <tr>
                   <td>Infrastructure Fund </td>
                   <td> <input type="number" name="infra" value="0" style="width: 100%" required=""/></td>
              </tr>
              <tr>
                   <td>Extra </td>
                   <td> <input type="number" name="extra" value="0" style="width: 100%" required=""/></td>
              </tr>
