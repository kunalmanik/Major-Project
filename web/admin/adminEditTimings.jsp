<%-- 
    Document   : adminEditTimings
    Created on : 19 Feb, 2018, 1:29:15 AM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
                ...
                <form action="../EditTimings" method="post">
                    
                <table id="bootstrap-data-table" class="table table-striped table-bordered" >
<!--                <tr><td><p style="padding-left: 30px;">ID : </p> </td> <td style=""><%=id%>  </td></tr>
-->                <input type="hidden" name="id" value=<%=id%>>
                <tr> <td> <p style="padding-left: 30px;">Header : </p></td> <td> <input type="text" name="head" value="<%=head%>"></td>
