<%-- 
    Document   : add_catagory
    Created on : 6 Feb, 2018, 12:49:09 PM
    Author     : kunal
--%>
                  ...
                  <div class="col-md-6 col-md offset-2" >
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                          ...
                          <form action="../adminAddTeam" method="post" class="form-horizontal" enctype="multipart/form-data">
                          <div class="row">
                              <label  class=" form-control-label" style="margin-left: 20px">Member Name</label></div>
                            <input type="text" id="cat_name" required  name="name" placeholder="Enter the Member Name" class="form-control"><div>
                          </div>
                          <div class="row">
                            <label  class=" form-control-label" style="margin-left: 20px">Title</label></div>
                            <input type="text" id="cat_name" required  name="title" placeholder="Enter the Member title" class="form-control"><div>
                          </div>
                           <div class="row">
                            <label class=" form-control-label" style="margin-left: 20px">Image</label></div>
                            <input required type="file" name="image" id="file" onchange="return fileValidation()"  class="form-control">
                          
                       <div class="row">
                            <label class=" form-control-label" style="margin-left: 20px">Department</label></div>
...
<!--                             <div>
                                 <div>
                                 <label><p style="color:#272c33;"><strong>Image Upload:</strong></p> </label>
                                 </div>
                                 <div>
                               <label><input type="file" name="image" size="50"/></label>
                                 </div>
                             </div>-->
