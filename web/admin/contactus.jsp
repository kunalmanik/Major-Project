<%-- 
    Document   : aboutus
    Created on : 6 Feb, 2018, 12:47:41 PM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <td><label style="margin: 10px"><%=rs.getString("email")%></label></td>
        <td><label style="margin: 10px"><%=rs.getString("subject")%></label></td>
        ...
        <%
            if(rs.getString("answered").equals("no"))
            {
        %>
        <td><a href="ReplyQuery.jsp?id=<%=rs.getString("id")%>">
        ...
        %>
        <td>
            <input disabled="" type="submit" style="margin: 10px" class="btn btn-danger" value="Replied "/>
