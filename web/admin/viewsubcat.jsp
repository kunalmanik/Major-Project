                  ...
                  <div class="col-md-12" >
                    <div class="card">
                      <div class="card-header">
                        <strong>View </strong>Sub Category
                      </div>
                        
   <%
                Class.forName("com.mysql.jdbc.Driver");  
                Connection con=new Connect_db().getConnection(); 
                PreparedStatement r=con.prepareStatement("SELECT sub.sub_id, cat.cat_name, sub.subcat, sub.visibility FROM category cat RIGHT JOIN sub_category sub ON cat.cat_name = sub.cat_name;");
    ...
    <tr>
       ...
       <td> <a href="editsubcat.jsp?id=<%=rs.getString("sub_id")%>">Edit</a>
       &nbsp;
        <a href="deletesubcat.jsp?id=<%=rs.getString("sub_id")%>">Delete</a>
        <% } %>  
