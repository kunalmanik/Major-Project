<%-- 
    Document   : AddPolicy
    Created on : 5 Mar, 2018, 2:40:46 PM
    Author     : kunal
--%>
                  ...
                  <div class="col-md-6 col-md offset-2" >
                    <div class="card">
                      <div class="card-header">
                        <strong>Add</strong> Policy
                      </div>
                      <div>
                          <form action="../adminAddPolicy" method="post">
                          <div >
                            <div ><label  >Policy</label></div>
                            <div ><textarea type="text" id="cat_name" name="name" rows="5" cols="45" placeholder="Enter the Policy"></textarea><div>
                          </div>
