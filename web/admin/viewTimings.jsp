<%-- 
    ...
    Created on : 19 Feb, 2018, 12:49:09 AM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                <tr><td><p><strong> Heading</strong></p></td><td> <%=rs.getString("heading")%></td></tr>
                <tr><td><p><strong>Description</strong></p> </td><td> <%=rs.getString("des")%></td></tr>
                       
                <tr>  
                    <td><p><strong>Action</strong></p> </td>
                      <td>
                          <a href="adminEditTimings.jsp?id=<%=rs.getString("id")%>&heading=<%=rs.getString("heading")%>&des=<%=rs.getString("des")%>"><strong>EDIT</strong> </a>  &nbsp;
                          <a href="../DeleteTimings?id=<%=rs.getString("id")%>" ><strong> DELETE</strong></a>
