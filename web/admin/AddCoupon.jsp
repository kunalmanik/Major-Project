<%-- 
    Document   : AddCoupon
    Created on : 19 Feb, 2018, 12:15:26 PM
    Author     : kunal
--%>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <center>
                            ...
                            <table class="table-primary" style="margin-top:100px; margin-right:100px;">
                                ...
                                <tr> <td> </td> <td> </td></tr>
                                 <tr>
                                    <td> Coupon Name </td>
                                    <td><input name="coupon_name" type="text" required="" style="width: 100%"/></td>
                                </tr>
                                <tr>
                                    <td> Coupon Discount </td>
                                    <td><input name="discount" type="number" max="100" required="" style="width: 100%"/></td>
                                </tr>
                                <tr>
                                    <td> Activation </td>
                                    <td>
                                        <select name="activation" style="width: 100%">
                                ...
                                <tr>
                                    <td> Coupon Use Allowed </td>
                                    <td><input name="counter" type="number" required="" style="width: 100%"/></td>
                                </tr>
                                 <tr>
