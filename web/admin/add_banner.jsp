                         ...
                         <form action="../ImageUpload" method="post" enctype="multipart/form-data">
                           <table>
                             <tr>
                                 ...
                                 <td><input type="file" name="image" size="50" id="file" onchange="return fileValidation()" required=""/></td>
                             </tr>
                             <!--<tr>
                                 <td><p style="color:#272c33;"><strong>Title:</strong></p></td><td><input type="text"  style="padding-right:0px;" name="title" autocomplete="off"style="height:30px;width:155px" placeholder="Enter title" required=""/></td>
