<%-- 
    Document   : adminEditCatImg
    Created on : 19 Feb, 2018, 2:13:03 AM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    %>
    <form  action="../adminEditCatImage" method="post" enctype="multipart/form-data">               
...
<input hidden="" type="text" name="cat_id"><%=id1%></label> 

<tr> <th>Category Name</th>
    <td><label type="text" name="productName" style="margin: 10px"><%=rs.getString("cat_name")%></label></td>
</tr>
<tr> <th>Image</th>
