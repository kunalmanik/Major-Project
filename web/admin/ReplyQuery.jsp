<%-- 
    Document   : ReplyQuery
    Created on : 6 Mar, 2018, 11:46:49 PM
    Author     : kunal
--%>
...
<head>
    ...
    <title>Contact Us - Blossom Flower Gallery</title>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <form method="post" action="../ReplyQuery">
        <table style="margin: 40px"class="table"> 
        <tr  style="border: solid 1px black;" >        
        <td><label style="margin: 10px"><%=rs.getString("name")%></label></td>
    <td><label style="margin: 10px">(<%=rs.getString("email")%>)</label></td>
        
        <td><label style="margin: 10px"><%=rs.getString("mobile")%></label></td>
        <td><textarea readonly="" rows = "8" cols = "40"  style="margin: 10px"><%=rs.getString("message")%></textarea></td>
        
        <td><input type="hidden" name="name" style="margin: 10px" value="<%=rs.getString("name")%>"/></td>
        <td><input type="hidden" name="id" style="margin: 10px" value="<%=id%>"/></td>
        <td><input type="hidden" name="email" style="margin: 10px" value="<%=rs.getString("email")%>"/></td>        
        <td><input type="hidden" name="mobile" style="margin: 10px" value="<%=rs.getString("mobile")%>"/></td>
        <td><input type="hidden" name="query" style="margin: 10px" value="<%=rs.getString("message")%>"/></td>
        
        </tr>
        </table>
        <table style="margin: 40px" class="table"> 
        <tr style="border: solid 1px black;">
            <td><textarea name="replyText" style="margin: 10px" rows="6" cols="45" required=""></textarea></td>
        </tr> <tr><td>
                <input type="submit" style="margin: 10px" class="btn btn-danger" value="Reply"/>            
            </td></tr>
