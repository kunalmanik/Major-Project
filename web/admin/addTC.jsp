            ...
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        ...
                        <center>
                            <form action="TCadd.jsp"> 
                            
                            <table class="table-primary" style="margin-top:100px; margin-right:100px;">
                            
                               <!-- <tr>
                                    <td> Page Header</td>
                                    <td> <input type="text" name="phead" style="margin-bottom:20px; padding-bottom:10px;" value="" />   </td>
                                </tr> -->
                                <tr>
                                    <td> Add Terms and Conditions</td>
                                    <td></td>
                                </tr>
                                <tr> <td> </td> <td> </td></tr>
                                 <tr>
                                    <td> Content </td>
                                    <td><textarea name="des" rows="8" cols="48"></textarea></td>
                                </tr>
                                <tr> <td> </td>
