            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-md offset-2" >
                      <a href="viewGalleryCat.jsp"><button type="submit" class="btn-outline-primary"> View Category</button></a>
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <form action="adminadd_galleryCategory.jsp" method="post" class="form-horizontal">
