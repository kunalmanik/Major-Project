<%-- 
    Document   : AddFAQ
    Created on : 6 Mar, 2018, 10:45:57 PM
    Author     : kunal
--%>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-md offset-2" >
                    <div class="card">
                      ...
                      <div>
                          <form action="../adminAddFAQ" method="post">
                               <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Question</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="faq_ques" name ="faq_ques"  placeholder="Enter Question and add ?" required class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Answer</label></div>
                            <div class="col-12 col-md-9"><textarea type="text" id="hf-email" name="faq_ans" placeholder="Enter Answer" required="" class="form-control"></textarea></div>
                          </div>
