            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                <% while (rs.next()) { %>
                    <tr>
                       ...
                       <td> <%=rs.getString("gallery_cat")%></td>
                       
                       <td>
                      <a href="adminEditGalleryCat.jsp?cat_id=<%=rs.getString("id")%>&cat_name=<%=rs.getString("gallery_cat")%>"> EDIT </a> </td>
                      <td>
                      <td> <a href="adminDeleteGalleryCat.jsp?id=<%=rs.getString("id")%>" > DELETE</a>
