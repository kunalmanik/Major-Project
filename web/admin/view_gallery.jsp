...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
		...
		<tbody>
                   ...
                   <tr>
                     <th scope="row"><img height=80px width=130px src="../gallery/<%=rs.getString("image")%>" style="margin: 30px"></th>
                     
                   
                           <form action="../ImageUploadGallery?id=<%=rs.getString("id")%>&name=<%=rs.getString("image")%>" method="post" enctype="multipart/form-data" style="padding: 40px; background-color: grey; margin: 30px; border-radius: 15px;">
                             <!-- <td><a href="edit_banner.jsp" style="color:blue;">Edit</a></td> -->                                              
                                <td>
                                 ...
                                 <select name="category">
                                    ...
                                    <input type="file" name="image" size="30" id="file" onchange="return fileValidation()" required=""/>
                ...
                <td> </td>
                            <td>
                 <form action="../RemoveGalleryImage?id=<%=rs.getString("id")%>&name=<%=rs.getString("image")%>&type=true" method="post">                      
