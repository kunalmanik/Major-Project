...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
            ...
            <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                ...
                <% while (rs.next()) { %>
                    <tr>
                        <input type="hidden" value="<%=rs.getString("cat_id")%>">
                       <td> <%=rs.getString("cat_name")%></td>
                       <td> <%=rs.getString("visibility")%></td>
                       <td>
                      <a href="adminEditCat.jsp?cat_id=<%=rs.getString("cat_id")%>&cat_name=<%=rs.getString("cat_name")%>&status=<%=rs.getString("visibility")%>"> EDIT </a> </td>
                      <td>
                      <td> <a href="adminDeleteCat.jsp?id=<%=rs.getString("cat_id")%>" > DELETE</a>
