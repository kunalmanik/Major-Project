<%-- 
    Document   : edit_testinomial
    Created on : 6 Feb, 2018, 12:52:56 PM
    Author     : kunal
--%>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Edit testinomial</li>
                        </ol>
                    </div>
                </div>
            </div>
                  ...
                  <div class="col-md-8 col-md offset-2" >
                    <div class="card">
                      <div class="card-header">
                        <strong>Edit</strong> Testinomials
                      </div>
                      <div class="card-body card-block">
                        <form action="" method="post" class="form-horizontal">
						  <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Name</label></div>
                            <div class="col-12 col-md-9"><input type="name"  placeholder="Enter  name..." class="form-control"></div>
                          </div>
						  <div class="row form-group">
                            <div class="col col-md-3"><label  class=" form-control-label">Testinomial Desscription</label></div>
                            <div class="col-12 col-md-9"><textarea type="name"  placeholder="Enter description here..." class="form-control"></textarea></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Image Title</label></div>
                            <div class="col-12 col-md-9"><input type="email" id="hf-email" name="hf-email" placeholder="Enter Image  Title..." class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Image</label></div>
                            <div class="col-12 col-md-9"><input type="file" name="hf-password"  class="form-control"></div>
                          </div>
                        </form>
                      </div>
