<%-- 
    Document   : ViewFAQ
    Created on : 6 Mar, 2018, 10:52:23 PM
    Author     : kunal
--%>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <!--<tr><td><p><strong>Page Header</strong></p></td><td></td></tr> -->
                <tr><td><p><strong> Question</strong></p></td><td> <%=rs.getString("ques")%></td></tr>
                <tr><td><p><strong>Answer</strong></p> </td><td><%=rs.getString("ans")%></td></tr>
                       
                <tr>  
                    <td><p><strong>Action</strong></p> </td>
                      <td>
                          <a href="adminEditFAQ.jsp?id=<%=rs.getString("id")%>&ques=<%=rs.getString("ques")%>&ans=<%=rs.getString("ans")%>"><strong>EDIT</strong> </a>  &nbsp;
                          <a href="../DeleteFAQ?id=<%=rs.getString("id")%>" ><strong> DELETE</strong></a>
