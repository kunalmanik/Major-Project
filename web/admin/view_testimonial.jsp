<%-- 
    Document   : view_testinomial
    Created on : 6 Feb, 2018, 12:55:45 PM
    Author     : kunal
--%>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">View Testinomial</li>
                        </ol>
                    </div>
                </div>
            </div>
						...
						<tr>
						 ...
						 <tbody>
                            ...
                            <tr>                              
                              ...
                              <td><a href="../EditTestimonial?id=<%=rs.getInt("id")%>&app=<%=rs.getString("approved")%>" style="color:blue;">Approve/Disapprove</a></td>
                              <td><a href="../DeleteTestimonial?id=<%=rs.getInt("id")%>" style="color:red;">Delete</a></td>
                          </tr>
                                                <%
                                                    }
                                                %>
