...
<!--                       <td> <%--=rs.getString("cat_id")--%></td>-->
                       ...
                       <td><img style="height:150px; width:150px" src="../team/<%=rs.getString("image")%>"></td>                    
                      <td>
                      <a href="adminEditTeam.jsp?team_id=<%=rs.getString("id")%>&name=<%=rs.getString("name")%>&title=<%=rs.getString("title")%>"> EDIT </a> </td>
                      <td>
                      <a href="adminEditTeamImage.jsp?team_id=<%=rs.getString("id")%>&image=<%=rs.getString("image")%>"> EDIT IMAGE</a> </td>
                     <td> <a href="../adminDeleteTeam?team_id=<%=rs.getString("id")%>" > DELETE</a>
