...
<table align="center" class="table">                        
                        <form  action="../adminEditTeamImage" method="post" enctype="multipart/form-data">               
...
String id1=request.getParameter("team_id");
Class.forName("com.mysql.jdbc.Driver");
Connection conn = new Connect_db().getConnection();
String query = "select * from team where id='"+id1+"'";
...
<tr> <td>  <th></th></td>
    <td><input hidden="" type="text" name="proid" value="<%=id1%>"/></td>
</tr>
<tr> <td> <th>Team Member Name</th></td>
    <td><input type="text" name="productName" value="<%=rs.getString("name")%>" readonly=""></td>
</tr>
<tr> <td> <th>Image</th></td>
    <td> <img src="../team/<%=rs.getString("image")%>" width="170px;"></td>
</tr>
<tr> <td> <th>Image Upload</th></td>
...
<tr>
    <td></td>
    <td> </td>
    <td><input type="submit" name="Submit" class="btn-outline-primary" value="Update" size="25"></td>
