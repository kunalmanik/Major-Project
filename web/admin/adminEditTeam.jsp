<%-- 
    Document   : adminEditCat
    Created on : 6 Feb, 2018, 2:36:21 PM
    Author     : kunal
--%>
...
<!--                <tr><td><p style="padding-left: 30px;">ID : </p> </td> <td style=""><%=id%>  </td></tr>
-->                <input type="hidden" name="team_id" value=<%=id%>>
<tr> <td> <p style="padding-left: 30px;">Name : </p></td> <td> <input type="text" name="name" value="<%=name%>"class="form-control" style="width:330px;"></td>
                    <tr> <td> <p style="padding-left: 30px;">Title : </p></td> <td> <input type="text" name="title" value="<%=title%>" class="form-control" style="width:330px;"></td>
                       <tr> <td> <p style="padding-left: 30px;">Department: </p></td> <td>  <select name="department" class="form-control" style="width:330px;">
