<%-- 
    Document   : add_banner
    Created on : 6 Feb, 2018, 12:48:19 PM
    Author     : kunal
--%>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
            <div class="col-sm-4">
                ...
                Connection co = DriverManager.getConnection("jdbc:mysql://localhost:3306/Blossom Flower Gallery", "root", "root");                                
            --%>
                  ...
                  <div class="col-md-6 col-md offset-2" >
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                         <form action="../ImageUploadGallery" method="post" enctype="multipart/form-data">
                           <table>
                             <tr>
                                 <td><p style="color:#272c33; margin-bottom:0px;"><strong>Image Upload : </strong></p> </td>
                               <td><input type="file" name="image" id="file" onchange="return fileValidation()" size="50"/></td>
                             </tr>
                          <tr>  <td><p style="color:#272c33;"><strong>Category</strong></p></td><td> <select name="category" style="width:70px;">
                               <%Class.forName("com.mysql.jdbc.Driver");
                               ...
                               <option value="<%=rs.getString("gallery_cat")%>"><%=rs.getString("gallery_cat")%></option>
                                      <% } %>
