<%-- 
    Document   : adminEditFAQ
    Created on : 6 Mar, 2018, 10:57:24 PM
    Author     : kunal
--%>
...
<!--                    <li class="menu-item-has-children dropdown">
    ...
    <!-- Right Panel -->
               ...
               <!-- <tr> <td> <p style="padding-left: 30px;">Page Header : </p></td> <td> <input type="text" name="phead" value="<%=ques%>"></td> -->
                    <tr> <td> <p style="padding-left: 30px;">Ques : </p></td> <td> <input type="text" name="ques" value="<%=ques%>"></td>
                <tr><td><p>Answer</p>
                    </td><td>
                        <textarea name="ans" rows="6" cols="36"><%=ans%></textarea></td></tr>
